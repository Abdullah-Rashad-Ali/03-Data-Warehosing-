...
CREATE SCHEMA IF NOT EXISTS
  `qwiklabs-gcp-00-2d010dbe49d6.yellow_taxi`
OPTIONS (
  location = "US"
);

CREATE OR REPLACE EXTERNAL TABLE
  `qwiklabs-gcp-00-2d010dbe49d6.yellow_taxi.external_yellow_tripdata_2024`
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://dezoomcamp-hw3-2025-abdullah/yellow_tripdata_2024-*.parquet']
);
...
CREATE OR REPLACE TABLE
  `qwiklabs-gcp-00-2d010dbe49d6.yellow_taxi.yellow_tripdata_2024`
AS
SELECT *
FROM `qwiklabs-gcp-00-2d010dbe49d6.yellow_taxi.external_yellow_tripdata_2024`;
...
select count(*) from `qwiklabs-gcp-00-2d010dbe49d6.yellow_taxi.yellow_tripdata_2024`;